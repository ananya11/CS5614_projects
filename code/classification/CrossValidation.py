...
def generate_xy(df, my_stop_words):                
    text1=np.array(df[1]) 
...
#    print (sel_kfeatures)
    mod_vectorizer = TfidfVectorizer(input=u'content',analyzer=u'word',norm='l2', 
                                     ngram_range=(1,3),lowercase = True, binary=True,
                                    vocabulary=sel_kfeatures) # , tokenizer=stemmed)
    X_dataset = mod_vectorizer.fit_transform(text1)
    
    return X_dataset, y, ch2
...
#    #test data
    in_raw='/Users/ananya/Desktop/dbms project/data/11_26/ebola23.csv'
    out_parsed='/Users/ananya/Desktop/dbms project/data/11_26/ebola23-out.csv'
    clean_rawtext(in_raw,out_parsed)
